...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "vendedor 1", "vendedor1@gmail.com", new DateTime(1998, 4,21), 1000.0, d1);
            Seller s2 = new Seller(2, "vendedor 2", "vendedor2@gmail.com", new DateTime(1997, 4, 21), 900, d2);
            Seller s3 = new Seller(3, "vendedor 3", "vendedor3@gmail.com", new DateTime(1996, 4, 21), 800.0, d3);
            Seller s4 = new Seller(4, "vendedor 4", "vendedor4@gmail.com", new DateTime(1995, 4, 21), 700.0, d4);
            Seller s5 = new Seller(5, "vendedor 5", "vendedor5@gmail.com", new DateTime(1993, 4, 21), 600.0, d4);
            Seller s6 = new Seller(6, "vendedor 6", "vendedor6@gmail.com", new DateTime(1992, 4, 21), 589.0, d1);
            ...
            SalesRecord r3 = new SalesRecord(3, new DateTime(2018, 09, 13), 4000.0, SalesStatus.Cancel, s4);
            ...
            SalesRecord r23 = new SalesRecord(23, new DateTime(2018, 10, 19), 11000.0, SalesStatus.Cancel, s2);
